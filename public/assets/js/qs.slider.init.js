...
$(document).ready(function () {
	...
	$('#qsSlider').qsSlider({
		...
		// Pricing
		PriceBase :	'0', 	// base price should be as per slider calculation (1CPU + 256MB RAM + 50GB HDD)
		PriceCPU :	'1', 	// per month per unit
		PriceRAM :	3000 , 	// per month per 1024 MB
		PriceHDD :	'0',  	// per month per 10 GB
				
		// Maximum Slider values
		MaxCPU	: '12',		// Maximum CPU
		MaxRAM	: '90',		// Maximum RAM //It should be + 2 like if you want maximum RAM 16 GB then make it 18 etc..		
