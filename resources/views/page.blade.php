...
<!-- Intro start-->
<section class="section bg-parallax p-b-80" id="contact" style="background: url(images/inter-gabitext.png) center center no-repeat;">
   
    {{--  <section class="section section-intro js-intro" id="intro" data-intro-bg="images/inter-gabitext.png" data-type="background" data-intro-layout="fullscreen">  --}}
        <div class="container">
            <article class="section-inner">
                <div class="row">
                    <div class="col-md-8">
                        <h3 class="title-intro">
                                <span id="typed" class="animated" data-intro-animate="fadeInRight" data-intro-delay="500"></span>
                        </h3>
                        <p class="intro-text">
                            <span class="animated" data-intro-delay="1100" data-intro-animate="fadeInDown">
                                    <p>Если вы попали на эту страницу, то вы точно знаете - тексты играют одну из ключевых ролей в привлечении новых клиентов. Особенно в Интернете.</p>
                                    <p> Меня зовут Газиза Габи. Я - копирайтер, писатель, блогер. Мои тексты для бизнеса отличаются концепцией, нативностью и свежими незаезженными идеями.</P>
                                    <p>Вы не получите текст, сверкающий выражениями: "гарантия качества", "профессиональная команда", "успешноразвивающаяся компания". Вы получите бренд, свою историю, отстроитесь от конкурентов, найдете свою фишку и получите ваше Уникальное торговое предложение. Давайте начнем с бесплатной консультации и аудита вашей ниши</p>


                            </span>
                        </p>
                        <button type="button" class="consult btn btn-primary">Бесплатная консультация</button>
                    </div>
                </div>
            </article>
        </div>
    ...
    <!-- section services-->
    <section class="sss section section-services bg-grey-1 p-t-110 p-b-90" id="services">
        ...
        <div class="container">
            ...
            <div class="section-inner">
                ...
                <div class="row justify-content-center">
                     {{--  ADS  --}}
                     <div class="inda col-sm-6 col-xs-12 col-md-4" data-aos="fade-up" data-aos-once="true">

                            <article class="ads servicegab card-primary card-service">

                                    <figure class="card-figure">
                                            <a class="card-link-overlay" href="#" data-toggle="modal" data-target="#project-ads">
                                            <img class="ico img-circle" src="/images/icons/ads.png" alt=""></a>
                                    </figure>

                                <header class="card-header">
                                    <h3 class=" service-title">Объявления</h3>
                                </header>

                                <div class="testt">
                                <p class="tex text-justify">
                                    Продавать на досках объявлений сегодня не только можно, но и нужно. Ежедневно тысячи людей что-то покупают и продают. Причем это не только б/у вещи, крупные компании уже давно размещают свои товары и проводят многотысячные сделки на OLX, Avito и других популярных досках. Каким должен быть текст объявления, чтобы его заметили? Мы знаем ;-)
                                </p>

                                <footer>
                                    <div class="ftr">
                                        <a class="card-link-overlay" href="#" data-toggle="modal" data-target="#project-ads">
                                        <sapn  class="pad btn btn-outline-primary">Подробнее</span></a>
                                    </div>
                                </footer>
                    ...
                    <div class="indb col-sm-6 col-xs-12 col-md-4" data-aos="fade-up" data-aos-once="true">
                        <article class="servicegab card-primary card-service">
                            <figure class="card-figure">
                                    <a class="card-link-overlay" href="#" data-toggle="modal" data-target="#project-smm">
                                <img class="ico img-circle" src="images/icons/kp.png" alt=""></a>
                            </figure>

                            <header class="card-header">
                                <h3 class=" service-title">Коммерчисое предложение</h3>
                            </header>
                            <div class="testt">
                                <p class="tex text-justify">Как познакомить клиента с вашим бизнесом? Первое, что он увидит - ваше Коммерческое предложение. В зависимости от температуры клиента (холодный, теплый, горячий), ему требуется разный подход. Например, холодный клиент не заинтересован в услуге. Нужно рассказать о выгодах. Теплому клиенту нужно рассказать, почему ему выгодно работать именно с вами, а не с вашим конкурентом. Такие и другие фишечки используют наши копирайтеры, для того, чтобы продать вашу услугу.</p>
                                <footer>
                                    <div class="ftr">
                                        <a class="card-link-overlay" href="#" data-toggle="modal" data-target="#project-kp">
                                        <sapn  class="pad btn btn-outline-primary">Подробнее</span></a>
                                    </div>
                                </footer>
                            </div>
                    ...
                    {{--  ARTICLE  --}}
                    <div class="indc col-sm-6 col-xs-12 col-md-4" data-aos="fade-up" data-aos-once="true">
                        <article class="servicegab card-primary card-service">
                                <figure class="card-figure">
                                        <a class="card-link-overlay" href="#" data-toggle="modal" data-target="#project-smm">
                                        <img class="ico img-circle" src="images/icons/article.png" alt=""></a>
                                </figure>
                            <header class="card-header">
                                <h3 class=" service-title">Статьи</h3>
                            </header>
                            <div class="testt">
                                <p class="tex text-justify">Статьи бывают разные: СЕО-оптимизированные, развлекательные, PR-статьи. СЕО-оптимизированные статьи помогают вашему сайту продвинуться вверх в поисковике. Чем больше ключевых слов будет использовано, тем чаще сайт будет отображаться в поисковой ленте. А это - заинтересованная аудитория, больше просмотров - выше конверсия.
                                        Имиджевые или PR статьи, инфоповоды нужны для того, чтобы о вас узнало, как можно больше человек. Люди доверяют брендам, которые всегда на слуху.
                                        Развлекательные статьи - это много сочного и интересного контента.Вы можете заказать регулярные статьи по вашей тематике от  наших копирайтеров.</p>
                                <footer>
                                    <div class="ftr">
                                        <a class="card-link-overlay" href="#" data-toggle="modal" data-target="#project-smm">
                                        <sapn  class="pad btn btn-outline-primary">Подробнее</span></a>
                         ...
                         {{--  SMM  --}}
                        <div class="indd col-sm-6 col-xs-12 col-md-4" data-aos="fade-up" data-aos-once="true">

                            <article class="smm servicegab card-primary card-service">
                                <figure class=" card-figure">
                                        <a class="card-link-overlay" href="#" data-toggle="modal" data-target="#project-smm">
                                    <img class="ico img-circle" src="images/icons/smm.png" alt=""></a>
                                </figure>

                                <header class="card-header">
                                    <h3 class=" service-title">SMM</h3>
                                </header>
                                <div class="testt">
                                <p class="tex text-justify">СММ - сегодня может заменить полноценный сайт. Бесплатная площадка с лояльной аудиторией. Но важно знать, что аудитория в социальных сетях не любит прямых продаж. Их нужно развлекать, давать пользу, удовлетворять любопытство и больше обычного человеского общения. Хотите продавать - не продавая? Мы знаем, как это делать ;-)</p>
                        ...
                        {{--  WEBTEXT  --}}
                        <div class="inde col-sm-6 col-xs-12 col-md-4" data-aos="fade-up" data-aos-once="true" >
                            <article class="servicegab card-primary card-service">
                                <figure class="card-figure">
                                        <a class="card-link-overlay" href="#" data-toggle="modal" data-target="#project-smm">
                                        <img class="ico img-circle" src="images/icons/webtext.png" alt=""></a>
                                </figure>
                                    <header class="card-header">
                                        <h3 class=" service-title">Тексты для сайта</h3>
                                    </header>
                                    <div class="testt">
                                        <p class="tex text-justify">У вас уже есть сайт? Скорее всего вы сами писали весь текст. Даже учитывая то, что вы лучше всех знаете свой продукт, позвольте нам написать о нем. И тогда вы влюбитесь в него еще больше. Потому что мы:
                                                Определим единую концепцию
                        ...
                        {{--  WEB  --}}
                        <div class="indv col-sm-6 col-xs-12 col-md-4" data-aos="fade-up" data-aos-once="true">

                            <article class=" webs servicegab card-primary card-service">

                                <figure class="card-figure">
                                        <a class="card-link-overlay" href="#" data-toggle="modal" data-target="#project-smm">
                                        <img class="ico img-circle" src="images/icons/web.png" alt=""></a>
                                ...
                                <div class="testt ">
                                <p class="tex text-justify">С чего начать бизнес? Современные успешные предприниматели не советуют вкладывать большие средства в аренду офиса и закуп товара в самом начале открытия бизнеса. Начните с Интернета. Сайт - это полноценный офис продаж и канал для привлечения клиентов.Поэтому каждое слово должно быть продуманным и стоять на своем месте.Блоки должны идти последовательно, а дизайн быть уникальным и продающим. При правильном подходе вы получите спрос на ваше предложение и постоянный поток клиентов.
                                        В агентстве "GabiText" над созданием сайта работает команда из 4-х человек: Проектный менеджер, дизайнер, копирайтер и программист.</p>
...
" />
    ...
    <section class="section section-contact bg-parallax p-t-110 p-b-80" id="contact" style="background: url(images/bg-contact.jpg) center center no-repeat;">
        ...
        <div class="container">
            <div class="section-inner">
                <h3 class="section-heading section-heading-light m-b-45">Контакты</h3>
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                    ...
                    <div class="container-fluid">
                        <div class="modal-header">
                            <div class="modal-header-logo">
                                <img src="/storage/{{(setting('site.logo'))}}" alt="Ora">
                            </div>
    ...
    {{-- SECTION SMM --}}
    <section class="section-project-smm modal fade js-modal" id="project-smm" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="loader"></div>
            <div class="modal-content">
                <div class="section-inner modal-primary">
                            ...
                            <div class="col-xl-12 ">
                                <div class="modal-body">
                                    <article class="post-project m-b-55">
                                        <div>
                                            <p class="intro-price">
                                                СММ - сегодня может заменить полноценный сайт. Бесплатная площадка с лояльной аудиторией. Но важно знать, что аудитория в социальных сетях не любит прямых продаж. Их нужно развлекать, давать пользу, удовлетворять любопытство и больше обычного человеского общения. Хотите продавать - не продавая? Мы знаем, как это делать ;-)
                                            </p>
                                        </div>

                                        <div class="row no-gutters justify-content-center">
                                            <div class="pricegp col-sm-12 ">
                                                <div class="post-image">
                                                 {{--  price  --}}

                                                   <div class="panel pricing-table">

                                                        <div class="pricing-plan zoom-effect-container">
                                                                <div class="image-card">
                                                                <img src="{{asset('assets/images/paper-plane.png')}}" alt="" class="pricing-img"></div>
                                                                <h2 class="pricing-header">Тест-драйв</h2>
                                                                <ul class="pricing-features">
                                                                <li class="pricing-features-item">Custom domains</li>
                                                                <li class="pricing-features-item">Sleeps after 30 mins of inactivity</li>
                                                                </ul>
                                                                <span class="pricing-price">3000</span>
                                                                <a href="#/" class="to-bo pricing-button is-featured">Сделать заказ</a>
                                                            </div>


                                                            <div class="pricing-plan zoom-effect-container">
                                                                <div class="image-card">
                                                                <img src="{{asset('assets/images/plane.png')}}" alt="" class="pricing-img"></div>
                                                                <h2 class="pricing-header">Бизнес</h2>
                                                                <ul class="pricing-features">
                                                                    <p>В тарифный план входит:</p>
                                                                    <div class="header-post slabels">

                                                                            <div class="values">
                                                                                <span class="week-header">1 Месяц</span>
                                                                                <div  class="label label-success">30 Постов</div>
                                                                            </div>

                                                                        </div>
                                                                    <li class="fa fa-check green"></li> <span class=" pricing-features-item">Аудит текущего аккаунта</span><br>
                                                                    <li class="fa fa-check green"></li>  <span class=" pricing-features-item">Разработка стратегии</span><br>
                                                                    <li class="fa fa-check green"></li> <span  class=" pricing-features-item">Написание текстов</span><br>
                                                                    <li class="fa fa-check green"></li> <span  class=" pricing-features-item">Подбор хэштегов</span><br>
                                                                    <li class="fa fa-times red"></li>   <span  class=" pricing-features-item">Выезд фотографа (Астана-Алматы)</span><br>
                                                                    <li class="fa fa-times red"></li>   <span class=" pricing-features-item">Настройка бизнес-аккаунта</span><br>
                                                                    <li class="fa fa-times red"></li>   <span  class=" pricing-features-item">Создание гео-метки</span><br>
                                                                    <li class="fa fa-times red"></li>   <span  class=" pricing-features-item">Обработка фотографий</span><br>
                                                                    <li class="fa fa-times red"></li>  <span  class="pricing-features-item">Публикация постов в определенное время</span><br>
                                                                    <li class="fa fa-times red"></li>  <span  class="pricing-features-item">Настройка рекламы (бюджет оплачивается отдельно)</span><br>
                                                                    <li class="fa fa-times red"></li>  <span  class="pricing-features-item">Реклама у блогеров, лидеров мнения, в пабликах</span>


                                                                </ul>
                                                                <span class="pricing-price">90000</span>
                                                                <a href="#/" class="to-bo pricing-button is-featured">Сделать заказ</a>
                                                            </div>

                                                            <div class="pricing-plan zoom-effect-container">
                                                                    <div class="image-card">
                                                                <img src="{{asset('assets/images/space-ship.png')}}" alt="" class="pricing-img"></div>
                                                                <h2 class="pricing-header">Прогресив</h2>
                                                                <ul class="pricing-features">
                                                                        <p>В тарифный план входит:</p>
                                                                        <div class="header-post slabels">
                                                                            ...
                                                                            <li class="fa fa-check green"></li>  <span  class=" pricing-features-item">Написание текстов</span><br>
                                                                            <li class="fa fa-check green"></li>   <span  class=" pricing-features-item">Подбор хэштегов</span><br>
                                                                            <li class="fa fa-check green"></li>   <span  class=" pricing-features-item">Выезд фотографа (Астана-Алматы)</span><br>
                                                                            <li class="fa fa-check green"></li>   <span class=" pricing-features-item">Настройка бизнес-аккаунта</span><br>
                                                                            <li class="fa fa-check green"></li>   <span  class=" pricing-features-item">Создание гео-метки</span><br>
                                                                            <li class="fa fa-check green"></li>   <span  class=" pricing-features-item">Обработка фотографий</span><br>
                                                                            <li class="fa fa-check green"></li>  <span  class="pricing-features-item">Публикация постов в определенное время</span><br>
                                                                            <li class="fa fa-check green"></li>  <span  class="pricing-features-item">Настройка рекламы (бюджет оплачивается отдельно)</span><br>
                                                                            <li class="fa fa-check green"></li>  <span  class="pricing-features-item">Реклама у блогеров, лидеров мнения, в пабликах</span>
                                                                </ul>
                                                                <span class="pricing-price">150000</span>
                                                                <a href="#/" class="to-bo pricing-button is-featured">Сделать заказ</a>
                                                            </div>

                                                            <div class="pricing-plan zoom-effect-container">
                                                                    <div class="image-card">
                                                                    <img src="{{asset('assets/images/gear.png')}}" alt="" class="pricing-img"></div>
                                                                    <h2 class="pricing-header ">Настроить</h2>
                                                                        ...
                                                                        <div id="qsSlider">
                                                                                    ...
                                                                                    <div id="QsControls">
                                                                                        ...
                                                                                        <div id="cpu" class="slider ui-slider-primary">
                                                                                                <h4 class="title-o title">Период:</h4>
                                                                                        </div>
                                                                                        <div class="slabels">
                                                                                        ...
                                                                                        <div id="ram" class="slider ui-slider-success"><h4 class="title-o title">Публикаций в месяц</h4>
                                                                                                {{--  <div class="sdecs">Укажите жедаемое количество публикаций в месяц</div>  --}}
                                                                                        </div>
                                                                                        <div class="slabels">
                                                                                            <div class="values">
                                                                                                <div id="hddvalue" class="label label-danger"></div>
                                                                                            </div>
                                                                                            <p>По тарифному плану:</p>
                                                                                        </div>
                                                                                        <div class="radiosw col-sm-12">
                                                                                        <input class="reup" id="bussnes" type="radio"  value="bus" checked name="smm"  >
                                                                                        <label for="bussnes"> Бизнес</label>
                                                                                        </div>
                                                                                        <div  class="radiosw col-sm-12">
                                                                                        <input class="reup" id="progresiv" type="radio" value="pro"  name="smm">
                                                                                        <label for="progresiv">Прогресив</label>
                                                                                        </div>
                                                                                    ...
                                                                                    <div id="QsPrice">
                                                                                        <div class="prices">
                                                                                            ...
                                                                                            <div id="presets">
                                                                                                ...
                                                                                                <span class="pricing-price"id="doller"></span>

                                                                                            </div>
                                                                                            <div class="row justify-content-center">
                                                                                            <div id="btn-buynow" class="to-bo pricing-button is-featured">Сделать заказ</div>
                                                                                        ...
                                                                                        <div class="hid">
                                                                                                <form action="/mail.php">
                                                                                                    <input id="mon" name="set" type="hidden" value="">
                                                                                                    <input id="post" name="set" type="hidden" value="">
                                                                                                    <input id="tarif" name="set" type="hidden" value="">
                                                                                                    <input id="sales" name="set" type="hidden" value="">
                                                                                                    <input id="salestotal" name="set" type="hidden" value="">
                                                                                                    <input id="total" name="set" type="hidden" value="">
                                                                                                   
                                                                                                         <input type="text" class="Name" placeholder="Ваше имя">
                                                                                                         <input type="text" class="phone" placeholder="Введите телефон">
                                                                                                         <input type="email" class="mail" placeholder="Введите e-mail">
                                                                                                    <input type="submit">
                                                                                               </form>
                                                                                            </div>
    ...
    {{--END SECTION SMM --}}
    {{-- SECTION WEB--}}
    <section class="section-project-web modal fade js-modal" id="project-web" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="loader"></div>
            <div class="modal-content">
                <div class="section-inner modal-primary">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-xl-11 col-lg-9">
                                <div class="modal-body">
                                    <article class="post-project m-b-55">
                                        <header class="post-header">
                                            <h3 class="post-title">Разработка веб сайтов</h3>
                                        </header>
                                        <div class="row no-gutters">
                                            <div class="col col-figure">
                                                <figure class="post-image">
...
{{--  ТУГЛ РАЗРАБОТКА САЙТОВ  --}}
    ...
    {{--END SECTION WEB --}}
    {{-- SECTION ADS --}}
    <section class="section-project-ads modal fade js-modal" id="project-ads" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="loader"></div>
                <div class="modal-content">
                    <div class="section-inner modal-primary">
                                                     ...
                                                     {{--  price  --}}
                                                       ...
                                                       <div class="panel pricing-table">
                                                            ...
                                                            <div class="pricing-plan zoom-effect-container">
                                                                    ...
                                                                    <h2 class="pricing-header">Тест-драйв</h2>
                                                                    <ul class="pricing-features">
                                                                            <li class="fa fa-check green"></li> <span class=" pricing-features-item">Публикация одного объявления</span><br>    
                                                                            <li class="fa fa-check green"></li> <span class=" pricing-features-item">Регистрация аккаунта</span><br>    
                                                                            <li class="fa fa-check green"></li> <span class=" pricing-features-item">Обработка изображения</span><br>
                                                                            <li class="fa fa-check green"></li> <span  class=" pricing-features-item">Написание текста</span><br>                                              
                                                                    </ul>
                                                                    <span class="pricing-price">3000</span>
                                                                    <a href="#/" class="to-bo pricing-button is-featured">Сделать заказ</a>
                                                                </div>
                                                                ...
                                                                <div class="pricing-plan zoom-effect-container">
                                                                    ...
                                                                    <ul class="pricing-features">
                                                                        ...
                                                                        <div class="header-post slabels">
                                                                            ...
                                                                            <li class="fa fa-check green"></li> <span class=" pricing-features-item">Публикация ассортимента товаров и услуг</span><br>    
                                                                            <li class="fa fa-check green"></li> <span class=" pricing-features-item">Отдельное объявление на каждый товар/услугу</span><br>    
                                                                            <li class="fa fa-check green"></li> <span class=" pricing-features-item">Регистрация аккаунта</span><br>    
                                                                            <li class="fa fa-check green"></li> <span class=" pricing-features-item">Обработка изображений</span><br>
                                                                            <li class="fa fa-check green"></li> <span  class=" pricing-features-item">Написание текстов</span><br>  
                                                                            ...
                                                                            <div id="qsSlider">
                                                                                        ...
                                                                                        <div id="QsControls">
                                                                                            ...
                                                                                            <div class="slabels">
                                                                                                <div class="values">
                                                                                                    <div id="cpuvalueads" class="label label-primary"></div>
                                                                                                </div>
                                                                                            </div>
                                                                                            ...
                                                                                            <div class="slabels">
                                                                                                ...
                                                                                                <div class="values">
                                                                                                    <div id="ramvalueads" class="label label-success"></div>
                                                                                                </div>
                                                                                        ...
                                                                                        <div id="QsPrice">
                                                                                            <div class="prices">
                                                                                                ...
                                                                                                <div class="row justify-content-center">
                                                                                                <div id="btn-buynow" class="to-bo pricing-button is-featured">Сделать заказ</div></div>
    ...
    {{--END SECTION ADS --}}
    {{-- SECTION KP --}}
    <section class="section-project-kp modal fade js-modal" id="project-kp" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="loader"></div>
            <div class="modal-content">
                <div class="section-inner modal-primary">
...
{{--
                    ...
                    <div class="container">
                      <div class="row">
                        <div class="col-md-6 text-md-left text-center align-self-center my-5">
                          <h1 class="display-1">Приветсвте</h1>
                          <p class="lead">A background with color. One is enough.</p>
                          <div class="row mt-5">
                            <div class="col-md-5 col-6">
                              <a href="#" class="btn btn-success">Заказать консультацию</a>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
        ...
        <div class="row">  --}}
            ...
            {{--  </div>
                    <div style="background:#1e3f52;" class="col-sm-12">
        ...
        @foreach($articles as $article)
               ...
               <div class="col-md-7">
                    ...
                    <img class="img-fluid rounded mb-3 mb-md-0" src="/storage/{{ $article->image}}" alt="">
                     </a>
                </div>
              <div class="col-md-5">
                    <h3>{{ $article->title }}</h3>
                 <p>{{ $article->excerpt}}</p>
               <a class="btn btn-primary" href="{{ route('articleShow',['slug'=>$article->slug]) }}">Читать далее</a>
                      </div>
           </div>
         <!-- /.row -->
